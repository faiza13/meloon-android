...
import com.artmeloon.ui.activity.BaseDrawerActivity;
import com.artmeloon.ui.activity.EpingleActivity;
import com.artmeloon.ui.activity.MainActivity;
import com.artmeloon.ui.activity.SocialMediaPublishActivity;
import com.artmeloon.ui.activity.UrlInfo;
...
if (epingle.getId_creator()!= BaseDrawerActivity.currentUserId){
        ...
        ((CellFeedViewHolder) viewHolder).btnepingle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                uploadImage(  epingle.getEpingle_path(),  epingle.getDescription());
    ...
    private void uploadImage(final String path,final String description) {
...
//                        Toast.makeText(PublishActivity.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(KEY_IMAGE, path);
                params.put(KEY_DESCRIPTION, description);
                params.put("idTableau",String.valueOf("8") );
    ...
    public static class CellFeedViewHolder extends RecyclerView.ViewHolder {
        ...
        Button btnFollow;
        @BindView(R.id.epingle)
        ImageButton btnepingle;
        Epingle feedItem;
        Context contextt;
