...
/**
 * Created by faiza on 03/12/2017.
 */
...
public class SingleFeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == SingleFeed.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((SingleFeed.CellFeedViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final SingleFeed.CellFeedViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
          ...
          SingleFeed.CellFeedViewHolder holder = (SingleFeed.CellFeedViewHolder) newHolder;

            animateHeartButton(holder);
            updateLikesCounter(holder, holder.getFeedItem().likesCount);
            if (SingleFeed.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void animateHeartButton(final SingleFeed.CellFeedViewHolder holder) {
    ...
    private void updateLikesCounter(SingleFeed.CellFeedViewHolder holder, int toValue) {
    ...
    private void animatePhotoLike(final SingleFeed.CellFeedViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(SingleFeed.CellFeedViewHolder holder) {
    ...
    private void resetLikeAnimationState(SingleFeed.CellFeedViewHolder holder) {
