...
import io.github.froger.instamaterial.ui.adapter.AbonneAdapter;
import io.github.froger.instamaterial.ui.model.User;

public class AbonnementActivity extends BaseDrawerActivity {
    ...
    private void ReadDataFromDB() {
        ...
        String url = UrlInfo.ip+"meloon/user/readAbonnement.php?idUser="+iSelectedItem;
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (success == 1) {
                        ...
                        JSONArray ja = response.getJSONArray("abonnement");
    ...
    private void setupComments(ArrayList list) {
        ...
        abonneAdapter = new AbonneAdapter(this,list,AbonnementActivity.this);
